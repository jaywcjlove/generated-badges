...
function getInputs(){var label=(0,core.getInput)('label')||':label';var labelColor=(0,core.getInput)('labelColor');var status=(0,core.getInput)('status')||':status';var color=(0,core.getInput)('color')||'blue';var style=(0,core.getInput)('style')||'classic';var scale=parseInt((0,core.getInput)('scale'),10);return{label:label,labelColor:labelColor,status:status,color:color,style:style,scale:Number.isNaN(scale)?1:scale};}try{;_asyncToGenerator(/*#__PURE__*/regenerator_default().mark(function _callee(){var options,gradientStr,output,svgPath,gradient,svgString,data;return regenerator_default().wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:options=getInputs();gradientStr=(0,core.getInput)('gradient');output=(0,core.getInput)('output')||'BADGES.svg';svgPath=external_path_default().resolve(process.cwd(),output);gradient=gradientStr.split(',').filter(Boolean);if(gradient.length===1){options.color=gradient[0];}(0,core.startGroup)("Inputs: ");(0,core.info)("gradient: ".concat(Array.isArray(gradient),", ").concat(gradient));(0,core.info)("".concat(JSON.stringify(options,null,2)));(0,core.endGroup)();svgString=(0,dist.badgen)(_objectSpread2({},options));if(Array.isArray(gradient)&&gradient.length>0){svgString=useColor(addGradient(svgString,gradient,'x'),'url(#x)');}(0,core.startGroup)("Svg String: \x1B[34m(".concat(svgPath,")\x1B[0m"));(0,core.info)("".concat(svgString));(0,core.endGroup)();(0,core.setOutput)('svg',svgString);data=new Uint8Array(Buffer.from(svgString));_context.next=19;return external_fs_default().promises.writeFile(svgPath,data);case 19:(0,core.info)("Generated: \"".concat(svgPath,"\""));case 20:case"end":return _context.stop();}}},_callee);}))();}catch(error){(0,core.setFailed)(error.message);}
})();
